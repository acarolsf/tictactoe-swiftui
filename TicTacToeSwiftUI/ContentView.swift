...
extension Color {
    ...
    static let background = Color(UIColor(named: "colorBg")!)
    
    // Color 1
    static let colorui = Color(UIColor(named: "Color2")!)
}
        ...
        ZStack {
            ...
            VStack {
                ...
                ZStack {
                    ...
                    (LinearGradient(gradient: Gradient(colors: [.background, .colorui, .background]), startPoint: .leading, endPoint: .trailing))
                        .overlay(RoundedRectangle(cornerRadius: 25.0).stroke(Color.white.opacity(0.9), lineWidth: 2)
                                    .frame(width: 380, height: 380, alignment: .center))
                    // Game Grid
                    VStack {
                            ...
                            ForEach(0..<9, id : \.self) { index in
                                ZStack {
                                    ...
                                    Color.yellow.opacity(1)
                                        .overlay(RoundedRectangle(cornerRadius: 20).stroke(Color.white, lineWidth: 4)).shadow(color: .black, radius: 10, x: 0.0, y: 0.0)
                ...
                HStack {
                    ...
                    ZStack {
                        ...
                        Color.background.opacity(0.8)
                            .overlay(RoundedRectangle(cornerRadius: 20).stroke(Color.white, lineWidth: 2)).shadow(color: .black, radius: 10, x: 0.0, y: 0.0)
                        Text("@ACAROLSF")
                            .font(.largeTitle)
                            .fontWeight(.thin)
                    ...
                    .cornerRadius(20).clipped().shadow(color: Color.black.opacity(0.5), radius: 10, x: 2.0, y: 3.0)
                    }
                }
